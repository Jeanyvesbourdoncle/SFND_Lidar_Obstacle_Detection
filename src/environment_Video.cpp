...
void cityBlock (pcl::visualization::PCLVisualizer::Ptr& viewer, ProcessPointClouds<pcl::PointXYZI>* const pointProcessorI, pcl::PointCloud<pcl::PointXYZI>:: Ptr& inputCloud)
{
// Pipeline - Step 1 : Open 3D viewer and display a single PCD file // NOT Used , the data load are imported in the main program()
